...
$script:WideRanges = @(
    ...
    # Emoji-presentation set Windows Terminal draws two cells wide (Task 7, spec D4) - includes the
    # old free-path bullet U+23FA and the launch screen's own update arrow U+2B06 (arrows 2B05-2B07).
    ...
    @(0x27BF, 0x27BF), @(0x2B05, 0x2B07), @(0x2B1B, 0x2B1C), @(0x2B50, 0x2B50),
    @(0x2B55, 0x2B55), @(0x1F004, 0x1F0CF), @(0x1F18E, 0x1F19A), @(0x1F1E6, 0x1F1FF),
    @(0x1F200, 0x1F2FF)
)
